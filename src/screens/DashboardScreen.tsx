          ...
          >
            ...
            <View className="flex-1">
              {aiModelStatus === 'not_downloaded' && (
                <>
                  <ThemedText className="font-bold text-sm">Unlock Echo AI</ThemedText>
                  ...
                  <View className="flex-row gap-4 mt-4">
                    ...
                    >
                      <ThemedText className="text-white font-bold text-xs">Setup Echo AI</ThemedText>
                    </TouchableOpacity>
                    <TouchableOpacity
                      onPress={() => {
                        triggerHaptic();
              ...
              {aiModelStatus === 'downloading' && (
                <>
                  <ThemedText className="font-bold text-sm">Downloading Echo AI...</ThemedText>
                  <View className="mt-3">
              ...
              {aiModelStatus === 'error' && (
                <>
                  <ThemedText className="font-bold text-sm" style={{ color: colors.danger }}>Echo AI Download Failed</ThemedText>
                  <ThemedText type="secondary" className="text-xs mt-1">
