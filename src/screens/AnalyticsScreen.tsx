    ...
    <ThemedSafeAreaView>
      ...
      >
        ...
        <View className="flex-row mb-6" style={{ gap: 10 }}>
          {[
            {
              label: `Spend · ${trendDays}d`,
              value: fmtShort(totalThisPeriod),
              color: colors.accent,
            },
            {
              label: "Income · month",
              value: fmtShort(Number(thisMonth.income)),
              color: colors.credit,
            },
            {
              label: "Net · month",
              value: `${monthNet < 0 ? "−" : "+"}${fmtShort(Math.abs(monthNet))}`,
              color: monthNet >= 0 ? colors.credit : colors.danger,
            },
          ].map((tile, i) => (
            <MotiView
              key={tile.label}
        ...
        <View
          className="flex-row mb-4 p-1 rounded-full self-start"
        ...
        {/* Spend trend chart */}
        <View
          className="p-4 rounded-apple-md border mb-6"
          style={{
            backgroundColor: colors.surface,
            borderColor: colors.border,
          }}
          ...
          <View className="flex-row justify-between mt-3">
            {trend.map((p, i) => (
              <ThemedText
                ...
                style={{ flex: 1, fontSize: 8, color: colors.secondary }}
              >
                {new Date(p.date)
        ...
        >
              ...
              return (
                <View
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    backgroundColor:
                      p.total > 0 ? colors.debit : colors.surfaceElevated,
          ...
          <View className="flex-row justify-between mt-2">
            ...
            >
              {rhythm[0]
                ? new Date(rhythm[0].date).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                  })
                : ""}
            ...
            >
              {rhythm.length > 0
                ? new Date(rhythm[rhythm.length - 1].date).toLocaleDateString(
                    "en-IN",
        ...
        {budgetUtil.length > 0 && (
          <View className="mb-6">
            ...
            <View
              className="p-4 rounded-apple-md border"
              style={{
                backgroundColor: colors.surface,
                borderColor: colors.border,
              }}
